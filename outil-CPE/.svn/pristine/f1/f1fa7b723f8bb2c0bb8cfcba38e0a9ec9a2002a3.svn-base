...
<div class="navbar navbar-fixed-top navbar-primary main" role="navigation">
    <div class="navbar-header pull-left">
        <div class="navbar-brand">
            ...
            <a href="#" class="appbrand innerL logo_brand"> <?php /*echo "FTE";*/ echo 'LOGO';  ?> </a>
        </div>
    </div>
   ...
   <?php if(isset($titre) &&  $titre !="TRAITEMENT"){ ?>
        <ul class="nav navbar-nav navbar-right hidden-xs">
            ...
            ?>
                ...
                <li><a href="<?php echo site_url('front/accueil'); ?>" class="menu-icon"><i class="fa fa-home"></i><span class="text_couleur"> Processus</span></a></li>
